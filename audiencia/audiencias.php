        ...
        <table border = '2' class="table table-striped table-hover" >
            ...
            <?php
                //=================CODIGO PARA RETORNO DOS DADOS=================================
                    ...
                    $sql = "SELECT usuario.nome_completo, audiencia.dia_mes, audiencia.hora, audiencia.arquivos FROM audiencia
                            JOIN usuario ON audiencia.matricula = usuario.id WHERE usuario.id = $usuario";
